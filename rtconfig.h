...
#define IDLE_THREAD_STACK_SIZE 10240
#define RT_DEBUG
...
#define RT_SDIO_THREAD_PRIORITY 25
...
#define TINA_USING_PWM1
#define TINA_USING_I2C0
#define TINA_USING_TP_ADC
#define TINA_USING_KEY_ADC
